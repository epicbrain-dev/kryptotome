...
pub use circuit::{
    compute_circuit_commitment, compute_circuit_signature_witness,
    compute_selective_signature_witness, create_entitlement_proof,
    create_selective_disclosure_proof, derive_circuit_blinding_for_commitment,
    deserialize_pk_compressed, deserialize_proof_base64, deserialize_proof_base64_url,
    deserialize_proof_compressed, deserialize_public_inputs_base64,
    deserialize_public_inputs_compressed, deserialize_vk_base64, deserialize_vk_compressed,
    generate_entitlement_setup, generate_selective_disclosure_setup,
    get_or_init_entitlement_prepared_vk, get_or_init_entitlement_setup,
    get_or_init_selective_disclosure_prepared_vk, get_or_init_selective_disclosure_setup,
    prepare_verifying_key, proof_from_urn, proof_to_urn, prove_entitlement_for_credential,
    prove_selective_disclosure_for_item, serialize_pk_compressed, serialize_proof_base64,
    ...
    verify_selective_disclosure_proof, verify_selective_disclosure_proof_prepared,
    EntitlementCircuit, EntitlementProofBundle, Groth16PreparedVerifyingKey, Groth16Proof,
    Groth16ProvingKey, Groth16VerifyingKey, SelectiveDisclosureCircuit,
    SelectiveDisclosureProofBundle, BUNDLE_MAGIC,
};
